		...
		<div className="relative w-screen h-full bg-bgColor layout">
			<div className="flex flex-row justify-between items-center sm:py-10 md:py-16 desk:py-20 ">
				<div className="sm:ml-8 md:ml-16">
					<div className="flex flex-row items-center sm:mb-10 md:mb-16 desk:mb-20">
					...
					<h1 className="sm:text-2xl md:text-3xl desk:text-5xl text-textContacts font-ball">
						<span>{t("slogan1")}</span>
						<br /> <p className="my-[10px]">{t("slogan2")}</p>
					</h1>
					<Image
						src={underLine}
						alt="underLine"
					...
					/>
					<Link
						href={`/${currentLocation}/getStarted`}
						className="border-2 border-borderColor rounded-[12px] text-secondaryTextColor sm:text-lg md:text-xl desk:text-2xl bg-btmContacts sm:px-4 md:px-6 desk:px-10 py-3"
					>
						Get Started
					</Link>
				</div>
