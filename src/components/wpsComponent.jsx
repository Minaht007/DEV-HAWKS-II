...
const title = "sm:text-2xl md:text-4xl font-bold py-6 text-textContacts";
const underTitle = "sm:text-2xl md:text-3xl font-bold py-3 text-textContacts";
			...
			<div className="md:py-16">
				...
				<div className={imgDivStyle}>
					...
					<div className="flex flex-col md:pl-6">
						...
						<p className={`${stepText} text-start`} style={{ textAlign: "justify" }}>
							{t("paragraph-3")}
						</p>
					</div>
				</div>
				...
				<div className={imgDivStyle}>
					...
					<div className="flex flex-col md:pl-6">
						...
						<p className={`${stepText} text-end`} style={{ textAlign: "justify" }}>
							{t("paragraph-4")}
						</p>
					</div>
				</div>

				<div className="flex flex-col pr-3 justify-center my-6 ">
					<p className={numberStyle}>3</p>
				</div>

				<div className={imgDivStyle}>
					<Image src={dev2Img} alt="dev2Img" width={300} height={400} className="rounded-md " />
				...
				<div className={imgDivStyle}>
					...
					<div className="flex flex-col my-3 md:pl-6">
