...
import glowProdFilterImg from "../../../public/img/example/glowoasis/glowProdFilter.jpg";
import glowAdminPanelImg from "../../../public/img/example/glowoasis/adminPanel.jpg";
    ...
    <div className="flex flex-wrap justify-around">
      ...
      <div className="flex flex-col sm:w-[400px]  desk:w-[600px] ">
        ...
        <div className="flex flex-row justify-around mt-6">
            <Link href={`/${currentLocation}/mainPage#contact`} className={linkStyle} >{t('btmPurchase')} 3500 {t('current')}</Link>
            <Link href={`/${currentLocation}/mainPage#contact`} className={linkStyle}>{t('btmPurchase')} 100 {t('currentRent')}</Link>
          </div>
      </div>
