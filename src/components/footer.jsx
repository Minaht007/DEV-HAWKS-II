...
const Footer = () => {
	...
	return (
		<div className="flex sm:flex-col desk:flex-row py-5 justify-around items-center bg-secondaryBG">
			<div className="flex flex-col sm:mb-5  md:w-2/3 desk:w-1/3">
				<div>
					<Image src={Logo2} alt="logo" width={140} height={60} className="w-80 h-54 " />
				</div>

				<div className="sm:hidden md:block">
					<p className="py-5  text-xl text-textContacts" style={{ textAlign: "justify" }}>
						{t("text")}
					</p>
				</div>
			</div>
